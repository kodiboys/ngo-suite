...
class AnalyticsReadModel:
    ...
    async def get_dashboard_data(self) -> dict[str, Any]:
        ...
        monthly_stats = await self.donation_repo.get_donations_by_date_range(
            start_of_month, now
        )

        # Wöchentliche Statistiken
        weekly_stats = await self.donation_repo.get_donations_by_date_range(
            start_of_week, now
        )
